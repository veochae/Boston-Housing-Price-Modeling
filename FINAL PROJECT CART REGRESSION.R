...
load("C:/Users/ajiang3/Downloads/realtor.spring.2020.rda")
...
z=read.csv("C:/Users/ajiang3/Desktop/MyRStudio/Rawdata/rural-demo.csv")
...
text(bestcut, cex=0.6, digits = max(nchar(mydata$myresponse))+3, pretty = 11)
...
if (tree_type=="R") {
  ...
  print(paste("MAE: ",error(forecast=final_table$predicted, true=final_table$myresponse, method="mae"), sep=""))#returns the MAE of prediction
  print(paste("MAPE: ", error(forecast=final_table$predicted, true=final_table$myresponse, method="mape"), sep=""))#returns the MAPE of prediction
